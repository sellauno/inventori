...
<div class="col-xxl-4 col-xl-12">
  ...
  <div class="card info-card customers-card">
    <div class="card-body">
      ...
      <br>
      <div class="d-flex align-items-center">
        <a href="{{ route('export', ['id' => $order->id_order]) }}"><button type="button" class="btn btn-primary">Cetak Laporan</button></a>
      </div>
      <br><br>
      <div class="d-flex align-items-center">
        <h6>Produksi</h6>
      ...
      <div class="d-flex align-items-center">
        <h6><a href="{{ route('hasilproduksiadd', ['id' => $order->id_order]) }}">
            <i class="bi bi-plus-circle"></i>
          </a></h6>
        <div class="ps-3">
          Tambah Data
